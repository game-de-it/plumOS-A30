...
Detailed UI policy lives in [A30 settings UI policy](a30-settings-policy.md).
...
Details live in [A30 runtime probe](a30-runtime-probe.md) and
[A30 stock SDL video path](a30-stock-sdl-video.md).
...
See [plumOS design policy](plumos-design-policy.md) for the current design
direction.
