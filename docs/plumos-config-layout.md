...
- `/mnt/SDCARD/plumos/config/frontend/settings.json`
  - UI Mode、TOP/ROM list 表示、sort、scan、boot resume など frontend の挙動。
...
- `/mnt/SDCARD/plumos/config/system/settings.json`
  - plumOS-owned の本体設定。Volume、Brightness、Lumination、Display Color、Time Settings、Language、Theme。
...
2026-06-10 時点では、`Language` と `Theme` 以外の値は保存直後と FE 起動時に A30
