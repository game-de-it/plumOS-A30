...
| MMF の display/input/audio 移植リスク | device-specific | A30 前提を分離し、MMF device profile を作ってから shared code を変更 | inventory probe 後、profile 別 build | [Miyoo Mini Flip 移植メモ](porting-miyoo-mini-flip.ja.md) |
