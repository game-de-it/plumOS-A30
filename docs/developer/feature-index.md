...
| MMF display/input/audio porting risks | device-specific | split A30 assumptions into a new MMF device profile before shared code changes | inventory probes, then profile-specific builds | [Miyoo Mini Flip Porting Notes](porting-miyoo-mini-flip.md) |
