...
2. [plumOS 設計方針](../plumos-design-policy.ja.md)
3. [設定ファイル配置方針](../plumos-config-layout.ja.md)
4. [runtime package](../runtime-package.ja.md)
5. [SD root package](../sdroot-package.ja.md)
6. [release artifacts](../release-artifacts.ja.md)
