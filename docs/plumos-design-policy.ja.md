...
[Stock frontend inventory](stock-frontend-inventory.ja.md) に分離します。
...
独自 data model は [plumOS frontend data model](frontend-data-model.ja.md) にまとめます。
判断記録には [Stock reuse decision template](decisions/stock-reuse-template.ja.md) を使います。
