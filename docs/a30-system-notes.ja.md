...
詳細な UI 方針は [A30 設定 UI 方針](a30-settings-policy.ja.md) に分離しています。
...
詳細は [A30 runtime probe](a30-runtime-probe.ja.md) と
[A30 stock SDL 画面出力経路](a30-stock-sdl-video.ja.md) にまとめています。
...
詳細は [A30 input policy](a30-input-policy.ja.md) に分離しています。
