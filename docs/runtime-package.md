...
`dist/plumos-runtime-package` は、実機の `/mnt/SDCARD/plumos` 配下へ展開する runtime 一式である。FE、launcher、RetroArch、libretro core、PicoArch、standalone emulator、Pyxel runtime、NextCommander file manager、SDL/Mali runtime、補助 userland を 1 つの配布単位にまとめる。
