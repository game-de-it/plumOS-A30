...
backbuffer を texture へコピーします。その後、物理 fb 用 EGL surface に切り替えて
GPU 上で回転 quad として描いてから swap します。これにより Pyxel のような標準
SDL2/GLES app を app 側 patch なしで A30 の物理横画面へ合わせます。
