...
| PCSX-ReARMed r26l | PS1 system の standalone default 候補 | native fb32 rotation、menu 640x480 landscape virtual、L2 menu profile、Function menu open/return、shadow clear、入力/音/ゲーム画面OK。 |
