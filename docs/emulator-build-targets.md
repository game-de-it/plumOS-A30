...
| ScummVM | `standalone:scummvm`, optional `retroarch:scummvm` | installed core | standalone は回転/マウス/theme 調整済みで初期default候補。PicoArch companion も analog axis 補正後に実機OK。 |
