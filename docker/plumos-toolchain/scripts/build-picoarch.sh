...
PICOARCH_A30_REPEAT_FRAME_PATCH=${PICOARCH_A30_REPEAT_FRAME_PATCH:-"${PATCH_DIR}/picoarch-a30-repeat-frame.patch"}
...
PICOARCH_A30_MAME2000_DEFAULTS_PATCH=${PICOARCH_A30_MAME2000_DEFAULTS_PATCH:-"${PATCH_DIR}/picoarch-a30-mame2000-defaults.patch"}
PICOARCH_A30_PERF_INTERFACE_PATCH=${PICOARCH_A30_PERF_INTERFACE_PATCH:-"${PATCH_DIR}/picoarch-a30-perf-interface.patch"}
PICOARCH_A30_GET_VARIABLE_RETURN_PATCH=${PICOARCH_A30_GET_VARIABLE_RETURN_PATCH:-"${PATCH_DIR}/picoarch-a30-get-variable-return.patch"}
PICOARCH_A30_TYRQUAKE_CONTROLLER_INIT_PATCH=${PICOARCH_A30_TYRQUAKE_CONTROLLER_INIT_PATCH:-"${PATCH_DIR}/picoarch-a30-tyrquake-controller-init.patch"}
...
checkout_source() {
  ...
  patch -d "${SRC_DIR}" -p1 <"${PICOARCH_A30_REPEAT_FRAME_PATCH}"
  ...
  patch -d "${SRC_DIR}" -p1 <"${PICOARCH_A30_MAME2000_DEFAULTS_PATCH}"
  patch -d "${SRC_DIR}" -p1 <"${PICOARCH_A30_PERF_INTERFACE_PATCH}"
  patch -d "${SRC_DIR}" -p1 <"${PICOARCH_A30_GET_VARIABLE_RETURN_PATCH}"
  patch -d "${SRC_DIR}" -p1 <"${PICOARCH_A30_TYRQUAKE_CONTROLLER_INIT_PATCH}"
