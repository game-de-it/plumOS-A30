...
Environment:
  ...
  PLUMOS_A30_DISPLAY_LOGICAL=640x480  Override PPSSPP layout dp size without swapping framebuffer pixels.
...
case "${id}" in
  ppsspp)
    ...
    export PLUMOS_A30_DISPLAY_LOGICAL=${PLUMOS_A30_DISPLAY_LOGICAL:-}
